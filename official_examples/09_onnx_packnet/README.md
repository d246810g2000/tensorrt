...
3. [ONNX-GraphSurgeon](https://github.com/NVIDIA/TensorRT/tree/release/7.1/tools/onnx_graphsurgeon)
...
pushd packnet-sfm && git checkout fec6d0b493b784cabe5e6bf9c65b996a83c63fe1 && popd
...
```
python convert_to_onnx.py --output model.onnx
```
